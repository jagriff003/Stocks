...
def backtest_momentum_strategy(data, lookback_months=12, min_momentum_months=6, top_n=2):
    """
...
def select_top_stocks_biweekly(composite_scores, data, top_n=2, min_data_days=200, hold_days=14):
    """
...
portfolio_performance, rebalance_history = select_top_stocks_biweekly(
    composite_scores, data, top_n=2, min_data_days=200, hold_days=28
)
